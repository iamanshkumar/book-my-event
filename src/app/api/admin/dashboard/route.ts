...
export async function GET(){
    try{
        ...
        const globalRevenue = bookingsData.reduce((sum: number, b: any) => sum + Number(b.totalPricePaid), 0);
        const globalTicketsSold = bookingsData.reduce((sum: number, b: any) => sum + b.quantity, 0);
